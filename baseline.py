...
class PipelineManager:
    def __init__(self, args, seed, missing_indices_dict=None):
        ...
        with open(f'{self.dir_path}dataset_{args.imputation_method}_missing={args.missing_prob}_seed{self.seed}.pkl', 'wb') as f:
...
if __name__ == "__main__":
    ...
    save_results(results_dict, pipeline_obj.dir_path, args, args.imputation_method)
