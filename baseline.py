    ...
    for idx, seed in enumerate(seeds):
        ...
        for subgroup in subgroups:
            ...
            for at_k in config.Evaluation.at_k:
                results[subgroup]['NDCG'][at_k][idx] = compute_NDCG(mi[subgroup]['true'], mi[subgroup]['miss'], at_k, true_rank, pred_rank)
                results[subgroup]['PREC'][at_k][idx] = compute_precision(mi[subgroup]['true'], mi[subgroup]['miss'], at_k, true_rank, pred_rank)
