...
class FeatureLatticeGraph:
    def __init__(self, dataset_path, feature_num, min_k=1, with_edge_attrs=False, workers=8):
        self.min_k = min_k
...
if __name__ == "__main__":
    ...
    parser.add_argument('--edge_attrs', type=bool, default=LatticeGeneration.with_edge_attrs,
                        help='add attributes sto the edges')
    parser.add_argument('--workers', type=int, default=8, help='num of parallel workers')
    ...
    lattice = FeatureLatticeGraph(dataset_path, feature_num, workers=args.workers)
